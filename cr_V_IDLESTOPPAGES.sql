  ...
  where s.timestop 
  /*>=current_date-1  */
  BETWEEN                  dispatcher.GetPredefinedTimeFrom ( /*:ParamDataFrom*/ 'за текущую смену' , 1 , SYSDATE, /*:ParamBeginPeriod*/ to_date(to_char(current_date,'dd.mm.yyyy')||' 00:00:00','dd.mm.yyyy hh24:mi:ss'))                 AND dispatcher.GetPredefinedTimeTo ( /*:ParamDataFrom*/ 'за текущую смену' , 1 , SYSDATE, /*:ParamEndPeriod*/ current_date)
