  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_USERSTOPPAGES_TRUCKS_PITE" ("VEHID", "TIMESTOP", "TIMEGO", "STOPPAGESTIME", "TIMEWORKMOTOR", "STOP_REASON", "STOP_REASON_CATEGORY", "DATE_SHIFT", "SHIFT", "LONGEST", "STOPPAGESTIME_HOUR") AS 
