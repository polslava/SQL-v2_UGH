  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_PLANFACT_HOURSUM_HALF_SHOV_0" ("SHIFTHOUR_HALF_T", "SHIFTHOUR_HALF", "SHIFTHOUR", "PLAN_HOUR_HALF", "SHOVID", "VOLUME", "PLANFACT_PERCENT", "PLANFACT_PERCENT100", "PLANFACT", "SHOV_TYPE") AS 
  SELECT
/*
27.01.2024
Ступин В.С.
