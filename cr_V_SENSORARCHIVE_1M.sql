  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_SENSORARCHIVE_1M" ("ID", "VEHID", "VEHTYPE", "GMTTIME", "SENSORID", "MINSENSORVALUE", "AVGSENSORVALUE", "MAXSENSORVALUE", "PERIODSECONDS", "DESCR_RU", "TIME", "SHIFTNUM", "SHIFTDATE") AS 
  select sa."ID",sa."VEHID",sa."VEHTYPE",sa."GMTTIME",sa."SENSORID",sa."MINSENSORVALUE",sa."AVGSENSORVALUE",sa."MAXSENSORVALUE",sa."PERIODSECONDS" 
    ...
    where sa.gmttime  between sysdate-30 and sysdate+1;
