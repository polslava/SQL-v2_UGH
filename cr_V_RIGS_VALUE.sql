  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_RIGS_VALUE" ("DATESHIFT", "WORKTYPE", "VALUE_FACT_M", "VALUE_FACT_HOLE", "RIGNAME", "BLOCK_NAME", "ENTERPRISENAME", "DIVISIONNAME") AS 
  select rv.DATESHIFT /*,SHIFT */
    ...
    group by rv.DATESHIFT,rv.WORKTYPE , rv.RIGNAME  ,   rv.BLOCK_NAME, ev.enterprisename, ev.divisionname;
