  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_PITE_PLANFACT_DAYS_SK" ("ENTERPRISENAME", "VALUE_PLAN_DAY", "VALUE_FACT_DAY", "PLANDATE1", "WORKTYPE", "RESULT_AUTO_SK", "PLAN_FACT") AS 
...
,2) as plan_fact
    ...
    where ppd.enterprisename like '%СтройКом%'
