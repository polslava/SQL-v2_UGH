  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_EVENTARCHIVE_CURR_GAL_VOLVO" ("MESCOUNTER", "VEHID", "EVENTTIME", "EVENTGMTTIME", "X", "Y", "EVENTGROUP", "EVENTCODE", "EVENTDESCR", "TIMESYSTEM", "VEHTYPE", "VEHCODE", "EVENTTYPE", "TIME", "MOTOHOURS", "WEIGHT", "FUEL", "SPEED", "MESNUMBER", "GEOZONE", "SHOVELID", "UNLOADID", "STATUS_DUMPTRUCK", "TIME1") AS 
  SELECT E.MESCOUNTER,
           E.VEHID,
           E.TIME as EVENTTIME,
        ...
        , ugh.f_getshovelidforpoint(e.x,e.y) as shovelid
...
, substr(cast(e.time as varchar(20)),0,16) as time1
    ...
    WHERE e.vehid like 'Volvo%' and e.vehtype = 'Самосвал'
    and e.time BETWEEN 
