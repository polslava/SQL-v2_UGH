  ...
  CREATE OR REPLACE FORCE VIEW "UGH"."V_IDS_CUR_LOADING" ("STOP_TIME_HOUR", "HOUR", "PRIM") AS 
...
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=1
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=2
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel2
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=3
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel3
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=4
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel4
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=5
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel5
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=6
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel6
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=7
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel7
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=8
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel8
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=9
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel9
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=10
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel10
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=11
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel11
union
...
(select /*ids.dateshift_hour_t, ids.dateshift_hour
    ,*/sum(ids.stop_time_hour) as stop_time_hour
from ugh.v_idlestoppages_cur ids
where stoppage_type = 'œŒ√–”« ¿' and ids.dateshift_hour<=12
--group by ids.dateshift_hour_t, ids.dateshift_hour
) sel12
) sel_1
